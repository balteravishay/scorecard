...
•	set the` RestoreLockedMode` attribute to true in all .csproj files in the repository.
...
An analysis of Scorecard checks for .NET repositories
GitHub open-source .NET community repositories analysis
